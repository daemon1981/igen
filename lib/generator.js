...
Generator.prototype.run = function (filename, keys, translations, callback) {
  ...
  async.parallel([
    ...
    function saveTranslationsKeys(next) {
      self.saveTranslationsKeys(filename, keysTranslations, next);
    }
  ], callback);
};
...
Generator.prototype.saveTranslationsKeys = function(filename, keysTranslations, callback) {
  this.getGenerator().run(keysTranslations, this.getLangFile(filename), callback);
};
